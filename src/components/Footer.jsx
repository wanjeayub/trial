        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="ml-3 text-xl font-bold">Geared Energy</span>
            </div>
            <p className="text-gray-400">
              Leading provider of boiler solutions, servicing, and spare parts in Kenya.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="mailto:info@gearedenergy.com" className="text-gray-400 hover:text-white transition block">
                  info@gearedenergy.com
                </a>
              </li>
              <li>
                <a href="mailto:sales@gearedenergy.com" className="text-gray-400 hover:text-white transition block">
                  sales@gearedenergy.com
                </a>
              </li>
              <li>
                <a href="mailto:support@gearedenergy.com" className="text-gray-400 hover:text-white transition block">
                  support@gearedenergy.com
                </a>
              </li>
              <li>
                <a href="mailto:quotes@gearedenergy.com" className="text-gray-400 hover:text-white transition block">
