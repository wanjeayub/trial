...
const About = () => {
  const values = [
    ...
    },
    {
      ...
      title: "Our Team",
      description:
        "Certified engineers and technicians with extensive experience in boiler systems and industrial heating.",
    },
    {
      icon: (
        <svg
      ...
      title: "Our Reach",
      description:
        "Serving clients across Kenya with a commitment to quality and timely service delivery.",
    },
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                In boiler systems and industrial heating
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Across various industries in Kenya
              </p>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-primary mb-2">50+</div>
