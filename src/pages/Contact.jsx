...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      details: ['info@gearedenergy.com', 'sales@gearedenergy.com', 'support@gearedenergy.com'],
      ...
      <section className="bg-gradient-to-r from-primary to-blue-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl max-w-3xl mx-auto text-blue-100">
            Get in touch with our team for boiler solutions, quotes, or technical support
          </p>
        </div>
      </section>
                ...
                <div key={index} className="flex items-start">
                  ...
                  <div>
                    ...
                    {info.action && (
                      ...
                      >
                        Contact via {info.title.toLowerCase().includes('email') ? 'Email' : info.title}
                      </a>
                    )}
                  </div>
                </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
              ...
              {submitted ? (
                <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
                  <svg xmlns="http://www.w3.org/2000/svg" className="text-green-500 mx-auto mb-4 h-12 w-12" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="mt-8 bg-gray-100 rounded-xl h-64 flex items-center justify-center">
              <div className="text-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="text-gray-400 mx-auto mb-2 h-8 w-8" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                </svg>
