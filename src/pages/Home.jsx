  ...
  const services = [
    {
      ...
      description: 'Professional installation of industrial and commercial boilers with certified expertise.'
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-primary" viewBox="0 0 20 20" fill="currentColor">
      ...
      description: 'Regular maintenance and servicing to ensure optimal performance and longevity.'
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-primary" viewBox="0 0 20 20" fill="currentColor">
      ...
      description: 'Genuine boiler spare parts from leading manufacturers with warranty.'
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-primary" viewBox="0 0 20 20" fill="currentColor">
      ...
      description: '24/7 emergency repair services for unexpected breakdowns and failures.'
    }
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl mb-8 text-blue-100">
                Your trusted partner for boiler installation, maintenance, and genuine spare parts supply.
                Serving industries across Kenya with excellence and reliability.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <a href="/services" className="bg-white text-primary hover:bg-gray-100 font-semibold py-3 px-6 rounded-lg transition duration-300 inline-flex items-center justify-center">
                  Our Services
                </a>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Comprehensive boiler solutions tailored to meet your industrial and commercial needs
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="bg-gray-300 h-96 rounded-xl shadow-lg flex items-center justify-center">
                <span className="text-gray-600">Boiler Maintenance Image</span>
              </div>
            </div>
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
                {features.map((feature, index) => (
                  <div key={index} className="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="text-green-500 mr-3 h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
